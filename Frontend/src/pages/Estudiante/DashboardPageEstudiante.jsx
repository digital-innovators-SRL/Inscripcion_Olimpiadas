...
const DashboardPageEstudiante = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const compRes = await axios.get(baseUrl + "competencias-estudiante", { headers });
        const tutoRes = await axios.get(baseUrl + "tutores", { headers });
  ...
  const handleInscripcion = async (idCompetencia) => {
    ...
    try {
      ...
      const response = await axios.post(baseUrl + "inscribirse", payload, { headers, responseType: 'blob' });
